...
const TreeSystem: React.FC = () => {
  ...
  const { foliageData, photosData, lightsData } = useMemo(() => {
    ...
    // 实际存在的照片文件列表
    const photoFiles = [
      "2016_11_1.png", "2017_02_1.png", "2018_01_1.png",
      "2018_01_2.png", "2018_02_1.png", "2018_05_1.png",
      "2018_05_2.png", "2019_02_1.png", "2019_02_2.png",
      "2019_05_1.png", "2019_08_1.png", "2020_02_1.png",
      "2021_06_1.png", "2021_06_2.png", "2021_12_1.png",
      "2021_12_2.png", "2022_01_1.png", "2022_02_1.png",
      "2022_04_1.png", "2022_07_1.png", "2022_08_1.png",
      "2022_09_1.png", "2022_09_2.png", "2023_02_1.png",
      "2023_08_1.png", "2023_08_2.png", "2023_08_3.png",
      "2023_10_1.png", "2023_12_1.png", "2024_04_1.png",
      "2024_11_6.png"
    ];
